...
<head>
    ...
    <title><?= $title ?? 'Staff Dashboard' ?> - AJIS Car Rental</title>
    ...
    <div class="d-flex">
        ...
        <div class="sidebar" id="sidebar">
                ...
                <nav class="nav flex-column">
                    <a class="nav-link <?= (uri_string() == 'staff' || uri_string() == 'staff/') ? 'active' : '' ?>" href="/staff">
                        <i class="fas fa-tachometer-alt"></i>
                        <span>Dashboard</span>
                    </a>
                    <a class="nav-link <?= (strpos(uri_string(), 'staff/bookings') !== false) ? 'active' : '' ?>" href="/staff/bookings">
                        <i class="fas fa-calendar-check"></i>
                        <span>Manage Bookings</span>
                        <?php if(isset($pendingBookings) && $pendingBookings > 0): ?>
                            <span class="notification-badge"><?= $pendingBookings ?></span>
                        <?php endif; ?>
                    </a>
                    <a class="nav-link <?= (strpos(uri_string(), 'staff/cars') !== false) ? 'active' : '' ?>" href="/staff/cars">
                        <i class="fas fa-car"></i>
                        <span>Manage Cars</span>
                    </a>
                    <a class="nav-link <?= (strpos(uri_string(), 'staff/customers') !== false) ? 'active' : '' ?>" href="/staff/customers">
